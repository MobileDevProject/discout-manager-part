...
static NSString * const kConsumerKey       = @"gGHFUBopBG9BQOTRAVSLag";
static NSString * const kConsumerSecret    = @"aCSU5ejRrNZRlD0Bk_eoLBr6ero";
static NSString * const kToken             = @"7w6LDJNceWkjeRlQyw06B7NvK4w2XZwq";
static NSString * const kTokenSecret       = @"9Ly_RPeXJ_fbRPldtMsPlXiK6WA";
